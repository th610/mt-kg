...
# from networkx.exception import ValueError
...
class Graph(object):
    ...
    **Subclasses (Advanced):**
    ...
    def __init__(self, data=None, **attr):
        ...
        if data is not None:
            # ! ok you dont we go to this case as your data is none so no need to edit function.
    ...
    def nbunch_iter(self, nbunch=None):
        ...
        or None, a ValueError is raised.  Also, if any object in
        nbunch is not hashable, a ValueError is raised.
        """
