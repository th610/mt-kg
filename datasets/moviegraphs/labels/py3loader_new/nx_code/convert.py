...
# ! you dont even need this function at all as the digraph initalised is empty data
def to_networkx_graph(data,create_using=None,multigraph_input=False):
    ...
    if hasattr(data,"adj"):
        try:
            ...
            raise ValueError("Input is not a correct NetworkX graph.")
    ...
    #     except:
    #         raise ValueError("Input is not a correct pygraphviz graph.")
    ...
    if (isinstance(data,list)
        ...
        try:
            ...
            raise ValueError("Input is not a valid edge list")

    # # Pandas DataFrame # ! edit 2 we dont need this for now
    # try:
    #     import pandas as pd
    ...
    # try: # ! edit 3 we dont need this for now
    #     import numpy
    ...
    # scipy sparse matrix - any format #! you dont even need code for this case as the digraph initalised is empty data
    # try:
    #     import scipy
