"""
Note this is the original code from NetworkX used for original drawing functions in MovieGraphs.
Due to change in Matplotlip Code base, this code is rewritten in functions.py. This lead to change 
in the function and the way the movie graphs are drawn. However, they do the purpose. 

We belive this code is still useful for reference and understanding the original drawing functions.
"""
